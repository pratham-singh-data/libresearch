...
export const Home = () => {
  ...
  return (
    <Box sx={{display: "flex", height: "90vh", flexDirection: "column", justifyContent: "center", alignItems: "center"}}>
        <Box sx={{width: {sm: "60%", xs: "100%"}, px: "20px", alignItems: "center", justifyContent: "center", display: "flex", flexDirection: "column"}}>
            <Avatar alt="LibreSearch Logo" src={LogoIMG} sx={{width: "25vh", height: "25vh", mb: "10px"}} />
